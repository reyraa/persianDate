(function(){
		...
		persianDate.getDay = function()
		{
			return persianDate.day;
		}
		persianDate.getMonth = function()
		{
			return persianDate.month;
		}
		persianDate.getYear = function()
		{
			return persianDate.year;
		}
		persianDate.getDate = function()
		{
			var temp = {'year' : persianDate.year , 'month' : persianDate.month , 'day' : persianDate.day , 'stringified' : persianDate.year +'/'+ persianDate.month +'/'+ persianDate.day};
			return temp;
		}	
